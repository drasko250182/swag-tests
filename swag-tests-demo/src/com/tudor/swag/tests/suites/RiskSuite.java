...
public class RiskSuite extends SwagletSuite {
	
//	@Test(invocationCount = 1, dataProvider = "RiskSwagletData", dataProviderClass = RiskSwagletDataProvider.class)
//	public void verifyData(ITestContext context, TableData tableData, Type type) {
//		super.verifyStageData(context, tableData, type);
//	}
